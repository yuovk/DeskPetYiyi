package com.deskpet.yiyi.service
...
class OverlayService : Service() {
    ...
    companion object {
        ...
        // 悬浮球大小：宽120-180px、高160-220px（约 44-65dp @44dpi，取中间 60x76dp）
        private const val PET_WIDTH_DP = 60
        private const val PET_HEIGHT_DP = 76
    }
    ...
    override fun onCreate() {
        ...
        startForeground(NOTIFICATION_ID, buildNotification("翊翊游到你屏幕上陪你啦 🐋"))
        setupOverlay()
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                CHANNEL_ID, "桌宠翊翊", NotificationManager.IMPORTANCE_LOW
